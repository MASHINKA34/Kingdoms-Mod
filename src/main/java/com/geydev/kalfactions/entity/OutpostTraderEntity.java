...
public final class OutpostTraderEntity extends PathfinderMob {
    public OutpostTraderEntity(EntityType<? extends OutpostTraderEntity> type, Level level) {
        super(type, level);
        setNoAi(true);
        setPersistenceRequired();
        setCustomName(Component.translatable("entity.kingdoms.outpost_trader"));
    ...
    protected InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            ...
            TraderService.open(serverPlayer, this);
        }
        return InteractionResult.SUCCESS;
    }
}
