...
public final class WarArchiveBlock extends Block {
    ...
    public WarArchiveBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    private static InteractionResult open(Level level, BlockPos pos, Player player) {
        if (!level.isClientSide() && player instanceof ServerPlayer serverPlayer) {
            FactionServerHooks.openWarArchive(serverPlayer, pos);
        }
