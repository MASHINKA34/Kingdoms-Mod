...
public enum ClusterResource {
    COAL(30, 24, 20, 18, false),
    COPPER(24, 20, 18, 16, false),
    ZINC(14, 14, 14, 13, false),
    IRON(22, 20, 19, 18, false),
    LAPIS(4, 7, 9, 10, false),
    REDSTONE(3, 7, 9, 10, false),
    GOLD(2, 5, 7, 9, true),
    DIAMOND(1, 3, 5, 6, true);

    private final int blueWeight;
    private final int yellowWeight;
    private final int redWeight;
    private final int blackWeight;
    private final boolean rare;

    ClusterResource(int blueWeight, int yellowWeight, int redWeight, int blackWeight, boolean rare) {
